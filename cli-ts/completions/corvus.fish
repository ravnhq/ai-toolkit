...
complete -c corvus -n "__fish_seen_subcommand_from install" -l claude        -d "Install to .claude/rules"
complete -c corvus -n "__fish_seen_subcommand_from install" -l cursor        -d "Install to .cursor/rules"
complete -c corvus -n "__fish_seen_subcommand_from install" -l codex         -d "Install to .codex/rules"
complete -c corvus -n "__fish_seen_subcommand_from install" -l global-claude -d "Install to global Claude rules"
complete -c corvus -n "__fish_seen_subcommand_from install" -l global-cursor -d "Install to global Cursor rules"
